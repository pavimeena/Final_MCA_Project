...
public class OwnLocationTag extends AppCompatActivity {
    String lat,lng;


    public TextView date,stime,etime,tlat,tlng;
    public EditText eventname,hostname,offers,entryfee,eventsize,description,name;
    public ImageView idate,istime,ietime,eventimage;
    public Button add;
    public Spinner spinner,envispinner,suitablespinner,session,placetype;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_own_location_tag);
...
//-------------------TextView-------------------------------------------
        ...
        tlat = findViewById(R.id.textView12);
        tlng = findViewById(R.id.textView21);
//-------------------EditText-----------------------------------------------
...
//-------------------Spinner-----------------------------------------------
        ...
        placetype = findViewById(R.id.spinner11);
//-----------------------------ProgessBar----------------------------------
        progressBar = findViewById(R.id.progressBar2);

        final SharedPreferences sharedPreferences = getSharedPreferences("prefe",MODE_PRIVATE);
        final SharedPreferences.Editor editor = sharedPreferences.edit();
        lat = sharedPreferences.getString("lat", String.valueOf(0));
        lng = sharedPreferences.getString("lng", String.valueOf(0));
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),DragMarker.class);
        ...
        istime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(OwnLocationTag.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
       ...
       // Toast.makeText(getApplicationContext(),"lat "+sharedPreferences.getString("lat",null)+"lng "+sharedPreferences.getString("lng",null),Toast.LENGTH_SHORT).show();
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(OwnLocationTag.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
    ...
    private void addTags() {
        ...
        final String stringplacetype = placetype.getSelectedItem().toString();
        ...
        if(tlng.getText().toString().equalsIgnoreCase("0")&& tlng.getText().toString().equalsIgnoreCase("0")){
            Toast.makeText(getApplicationContext(),"please Select Place",Toast.LENGTH_SHORT).show();
        }
        ...
        if (stringplacetype.equalsIgnoreCase("")) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.URL_TAGS,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("placetype", stringplacetype);
