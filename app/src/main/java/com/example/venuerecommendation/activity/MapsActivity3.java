...
public class MapsActivity3 extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void nearbyPlaces(final String placeType) {
        ...
        String url = getUrl(clat, clng, placeType);
                    ...
                    public void onResponse(Call<MyPlaces> call, Response<MyPlaces> response) {
                        ...
                        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
                            ...
                            public boolean onMarkerClick(final Marker marker) {
                                final Dialog dialog = new Dialog(MapsActivity3.this);
                                ...
                                add.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Intent intent = new Intent(getApplicationContext(), FinalPlaceActivity.class);
            ...
            public void onResponse(String response) {
                ...
                try{
                    ...
                    for(int i=0;i<result.length();i++){
                        ...
                        Log.e("test",lat_i);
                        double di = distance(clat,clng,Double.parseDouble(lat_i),Double.parseDouble(long_i),"K");
